...
config :data, DataWeb.Endpoint,
  ...
  secret_key_base: "1tvavCTCsNHuyVaoW5thF33djvtPJ9oowfeO4OO+XR+bgDLWXJ2XQtsWAnkXYPNW",
  server: false
...
config :api, ApiWeb.Endpoint,
  http: [ip: {127, 0, 0, 1}, port: 4002],
  secret_key_base: "LlD2q/nIa2iJqtlpFAlOFXtn2AiujdNxkA73cS2irelvM9exr5Pe1kOKGq0VqDWn",
  server: false
